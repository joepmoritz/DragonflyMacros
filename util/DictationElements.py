import re
from dragonfly.grammar.elements import Repetition, DictateWord
...
class DictateKnown(DictateWords):
	def __init__(self, words, min=1, max=10, name=None, default=None, joinWith=' ', format=True):
		DictateWords.__init__(self, name, min, max, default, joinWith, format)
		self.words = words
...
class DictateMapping(DictateKnown):
	def __init__(self, words, min=1, max=10, name=None, default=None, joinWith=' ', format=True):
		DictateKnown.__init__(self, words, min, max, name, default, joinWith, format)
...
class DictInteger(DictateKnown):
	...
	def __init__(self, name=None, optional = False, default=None):
		...
		DictateKnown.__init__(self, number_words, min, 10, name, default, None, True)
